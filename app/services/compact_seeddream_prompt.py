...
def _build_compact_prompt(
    ...
    *,
    ...
    pose_mannequin_block = (
        ...
        f"If IMG{mi} is waist-up / upper crop, keep the same waist-up framing. "
        f"If IMG{mi} is full-length / head-to-toe, keep full-body framing. "
        f"Do NOT expand a partial crop to full body. "
        f"Do NOT crop in tighter when the mannequin is full body.\n"
        ...
        f"do not add or infer legs, hips, or feet outside the mannequin crop for upper-only framing.\n"
